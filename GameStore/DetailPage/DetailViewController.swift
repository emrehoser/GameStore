...
class DetailViewController: UIViewController {
    ...
    lazy var detailView: DetailView = {
        let view = DetailView(gameId: gameId)
        return view
    }()
    ...
    override func viewDidLoad() {
        ...
        _ = detailView.anchor(self.view.topAnchor, left: self.view.leftAnchor, bottom: self.view.bottomAnchor, right: self.view.rightAnchor, topConstant: 0, leftConstant: 0, bottomConstant: 0, rightConstant: 0, widthConstant: 0, heightConstant: 0)
