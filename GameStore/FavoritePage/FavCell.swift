...
class FavCell: UICollectionViewCell {
    ...
    public func configure(with game: FavoriteItem) {

        setImageWithAlamofireImage(imageView: gameImageView, urlString: game.imageurl!)
        setTitle(title: game.name!)
    ...
    func setMetacritic(critic: String) {
